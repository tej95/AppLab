...
<i className="faSolid faCircleNodes"></i>
const header = (props) => {
  return (
    <>
   <nav className={`navbar navbar-default ${props.color} bg-transparent`}>
    <div className="container">
      <div className="navbar-header">
        <p className="navbar-brand bg-transparent " > <span className="icon" style={{color:'white'}}> <FontAwesomeIcon icon={faCircleNodes} size="2xl" /></span>
        ...
        <ul className="nav navbar-nav navbar-right mt-4 rounded-xl gap-3 ">
          ...
          <li id="contact" className=' rounded-3xl hover:drop-shadow-xl'><a href="/contact" style={{color: "white"}}>Log In</a></li>
        </ul>
    </div>
  </nav>
